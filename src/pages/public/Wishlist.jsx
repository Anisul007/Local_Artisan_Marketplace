                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-2 flex flex-wrap gap-2">
                      <button
                        ...
                        className="inline-flex items-center gap-2 rounded-xl bg-purple-600 px-3 py-2 text-sm font-semibold text-white hover:bg-purple-700 disabled:cursor-not-allowed disabled:bg-gray-400 disabled:hover:bg-gray-400"
                        onClick={() => {
                          addItem({
                      ...
                      >
                        <ShoppingCart className="w-4 h-4" /> {purchaseBlocked ? "Customer only" : "Move to cart"}
                      </button>
                      <button
                        type="button"
