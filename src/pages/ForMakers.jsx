...
const FAQS = [
  { q: "How do I become a vendor?", a: "Click 'Join as a Maker' and complete the registration form with your business details. Our team will verify and approve you within ~48 hours." },
  { q: "Is there a fee to list my products?", a: "We charge a small commission per sale. There are no upfront listing fees—makers earn as they sell." },
    ...
    <div className="mt-8 flex justify-center gap-4">
      ...
      <section className="container pb-4 grid gap-10 md:grid-cols-2 lg:grid-cols-4">
        {[{
          ...
          Icon: FaUsers, title: "Community Support", desc: "Connect with fellow makers, share tips, and grow together."
      ...
      <section style={{ backgroundColor: brand.yellow + "30" }} className="py-16">
        <div className="container">
          <h2 style={{ color: brand.purple }} className="text-2xl md:text-3xl font-bold text-center mb-10">What Makers Say</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {[1, 2, 3].map((i) => (
              <div key={i} className="rounded-2xl p-6 transition shadow"
                ...
                <div style={{ color: brand.orange }} className="mt-4 text-sm font-semibold">— Maker {i}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="container pb-20">
        <div className="rounded-2xl p-8 text-center shadow" style={{ backgroundColor: brand.purple, color: "#fff" }}>
          ...
          <p style={{ color: brand.yellow }} className="mt-2">Join our growing marketplace of makers and reach customers nationwide.</p>
          <a href="/register-vendor" className="mt-6 inline-block px-6 py-3 rounded-xl font-semibold hover:opacity-90"
